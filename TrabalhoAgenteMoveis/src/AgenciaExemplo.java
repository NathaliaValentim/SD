...
public class AgenciaExemplo extends UnicastRemoteObject implements AgenciaInterface{

	private static final int porta=1099;
	private static final String nome="AgenciaExemplo";
	private String registro="";
	
	private String erro="Connection reset";
	private String nomeAgente="";
	protected AgenciaExemplo() throws RemoteException {
		super();
	...
	private static AgenciaExemplo agencia=null;
	...
	public static void main(String[] args) {
		...
		try {
			...
			servicos.add(new ServicoExemplo());
			File dir = new File(".");
		...
		System.out.println("AgenciaExemplo Ligada!");
